...
This is one of 14 Claude Code plugins in the [Blend Spark Harness](https://github.com/BLEND360). Work is tracked in Jira project [PM3](https://blend360.atlassian.net/jira/core/projects/PM3/board) — filter by label `plugin:cv`.
