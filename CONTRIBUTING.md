# Contributing to ml-automation-cv

This is one of 14 Claude Code plugins in the Blend Spark Harness. Work is tracked in Jira project **[PM3](https://blend360.atlassian.net/jira/core/projects/PM3/board)** — filter by label `plugin:cv` for this plugin's slice.
...
```bash
git clone git@github.com:BLEND360/ml-automation-cv.git
cd ml-automation-cv
